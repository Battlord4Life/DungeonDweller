...
{
    public class NightVisionSprite : ISprite
    {
        ...
        public bool Collides(ISprite other)
        {
            ...
            if (temp)
            {
                if(other.Name == "Hero")
                {
                    if (((Hero)other).Items.Contains("Night Vision"))
                    {
                        ((Hero)other).Batteries += 4;
                    }
                    else
                    {
                        ((Hero)other).Items.Add("Night Vision");
                    }
                }
            }
        ...
        {
            _texture = content.Load<Texture2D>("NightVision64");
        }
