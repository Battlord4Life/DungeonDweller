...
{
    public class LightGearEnemy: ISprite
    {
        ...
        public LightGearEnemy(Vector2 Pos, int Diff, bool horizontal, float speed)
        {
            _scale = 4;
        ...
        public void LoadContent(ContentManager content)
        {
           ...
           _texture = content.Load<Texture2D>("FlameFinalGear");
