...
{
    public class DarkDweller : ISprite
    {
        ...
        public BoundingRectangle Bounds { get => new(new(Position.X + 8, Position.Y + 8), 32, 32); }

        public string Name => "DarkDweller";


        bool _update = false;

        public DarkDweller(Vector2 Pos, float speed, Tilemap tim)
        {
            _scale = 4;
        ...
        public void LoadContent(ContentManager content)
        {
            ...
            _texture = content.Load<Texture2D>("DarkStalker");
