...
namespace DungeonDweller.Screens
{
    ...
    public class Level5 : GameScreen
    {
        ...
        public override void Activate()
        {
            ...
            _backgroundSprite = new Tilemap("Level5Map.txt");
            ...
            _hero = new Hero(new Vector2(0, 19), _inputManager);

            _exit = new ExitSprite(new(19, 0));

            _stalkerL = new LightDweller(new Vector2(10, 10), 100, _backgroundSprite); //Change to Light Dweller when develoepd
            ...
            _GameplaySprites.Add(new Torch(new(19, 19)));
            _GameplaySprites.Add(new Torch(new(19, 10)));
            _GameplaySprites.Add(new Torch(new(10, 0)));
            _GameplaySprites.Add(new Torch(new(0, 10)));
            _GameplaySprites.Add(new Torch(new(0, 0)));
            _GameplaySprites.Add(new Torch(new(10, 19)));
            ...
            _Song = _content.Load<Song>("BloodyLightsFin");
        ...
        public override void HandleInput(GameTime gameTime, InputState input)
        {
            ...
            if (_pauseAction.Occurred(input, ControllingPlayer, out player) || gamePadDisconnected)
            {
                ...
                ScreenManager.AddScreen(new PauseMenuScreen(5), ControllingPlayer);
