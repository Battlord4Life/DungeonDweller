...
namespace DungeonDweller.Screens
{
    ...
    public class Level1 : GameScreen
    {
        ...
        public override void Activate()
        {
            ...
            _hero = new Hero(new Vector2((1280 / 20) * 9, (1280 / 20) * 19), _inputManager);
           
            _exit = new ExitSprite(new(64 * 9, 64 * 11));

            _GameplaySprites.Add(_exit);
            _GameplaySprites.Add(_hero);

            //Adds other set sprites that dont change
            _GameplaySprites.Add(new Flame(new Vector2((1280 / 20) * 3, (1280 / 20) * 9), (1280 / 20) * 5, false));
            _GameplaySprites.Add(new Flame(new Vector2((1280 / 20) * 14, (1280 / 20) * 9), (1280 / 20) * 5, true));
            _GameplaySprites.Add(new LanternSprite(new Vector2((1280 / 20) * 9, (1280 / 20) * 15)));
            _GameplaySprites.Add(new NightVisionSprite(new Vector2((1280 / 20) * 9, (1280 / 20) * 18)));
            _GameplaySprites.Add(new Torch(new Vector2((1280 / 20) * 9, (1280 / 20) * 13)));
